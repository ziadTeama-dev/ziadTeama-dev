...
**LoRA · QLoRA · Unsloth · Hugging Face**

Fine-tuned Qwen2.5-1.5B-Instruct using parameter-efficient fine-tuning and deployed the resulting model as an interactive application.
